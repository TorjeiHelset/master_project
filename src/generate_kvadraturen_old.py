...
def create_minimal_junctions_w_params(v_strand_fw, v_strand_bw, h_w, tollbod_fw, tollbod_bw,
                                      elvegata_fw, elvegata_bw, dronning_fw, dronning_bw,
                                      festning_fw, festning_bw, lundsbro_fw, lundsbro_bw,
                                      vs_cycle_1 = [torch.tensor(50.0), torch.tensor(100.0)], vs_cycle_2 = [torch.tensor(50.0), torch.tensor(100.0)],
                                      vs_cycle_3 = [torch.tensor(50.0), torch.tensor(100.0)], vs_cycle_4 = [torch.tensor(50.0), torch.tensor(100.0)],
                                      vs_cycle_5 = [torch.tensor(50.0), torch.tensor(100.0)], vs_cycle_6 = [torch.tensor(60.0), torch.tensor(60.0)],
                                      hw_cycle = [torch.tensor(100.0), torch.tensor(50.0)], tollbod_cycle = [torch.tensor(50.0), torch.tensor(100.0)],
                                      dronning_cycle_1 = [torch.tensor(60.0), torch.tensor(60.0)], dronning_cycle_2 = [torch.tensor(100.0), torch.tensor(50.0)],
                                      dronning_cycle_3 = [torch.tensor(50.0), torch.tensor(100.0)], festning_cycle_1 = [torch.tensor(60.0), torch.tensor(60.0)],
                                      festning_cycle_2 = [torch.tensor(60.0), torch.tensor(60.0)],
                                      track_grad = True):
