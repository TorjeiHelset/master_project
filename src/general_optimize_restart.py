...
def create_network_from_speeds_cycles(T, N, speed_limits, cycle_times, track_grad = True):
    match optimize_case:
        case 0:
            # Optimize single bus 
            nw.RestartingRoadNetwork(T, N, speed_limits, control_points, cycle_times, config)
...
def gradient_descent_first_step(T, N, speed_limits, cycle_times):
    ...
    restart_network = nw.GeneralRestartingRoadNetwork(T, N, speed_limits, control_points, cycle_times,
                                                      config, optimize_case)
...
if __name__ == "__main__":
    ...
    match option:
        case 0:
            ...
            result_file = "optimization_results/general_optimization/two_two_junction_restart.json"
        ...
        case 1:
            ...
            network_file = "optimization_cases/two_two_junction/network_file.json"
            config_file = "optimization_cases/two_two_junction/config_file.json"
            result_file = "optimization_results/general_optimization/two_two_junction_restart_alt_start.json"
            gradient_descent(network_file, config_file, result_file, overwrite=True, debugging=False)
        ...
        case 2:
            ...
            result_file = "optimization_results/general_optimization/medium_complex_restart.json"
            gradient_descent(network_file, config_file, result_file, overwrite=True, debugging=False)
        ...
        case 3:
            ...
            config_file = "optimization_cases/medium_complex/config_file.json"
            result_file = "optimization_results/general_optimization/medium_complex_restart_1.json"
            gradient_descent(network_file, config_file, result_file, overwrite=True, debugging=False)